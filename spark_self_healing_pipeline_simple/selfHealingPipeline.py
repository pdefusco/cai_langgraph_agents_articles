    ...
    prompt = [
        SystemMessage(
            content=(
                ...
                "6. Keep the main logic, table writes, merges, and generator structure intact, but do change anything needed in the logic to make the updated script run and succeed.\n"
                "7. Feel free to change column names in the logic whenever needed, in order to make the application run."
