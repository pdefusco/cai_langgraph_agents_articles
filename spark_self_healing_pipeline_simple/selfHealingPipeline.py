    ...
    prompt = [
        SystemMessage(
            content=(
                ...
                "6. Work with the same tables and try to achieve the same goal, but change only what is required to make the script run and succeed.\n"
                "6a. Apply the smallest possible set of changes required to fix the failure.\n"
                "6b. Do not refactor, normalize, or rewrite logic that is already valid.\n"
                ...
                "9. If a column is not found, select the most likely matching columns.\n"
                ...
                "14. If a spark sql statement has invalid references, replace only the side that is invalid. Do not modify the other side unless it also prevents execution.\n"
