    ...
    prompt = [
        SystemMessage(
            content=(
                ...
                "8. Do not add a How to Run or any other comments and docstrings at the end of the script.\n"
                "9. Do not add any markdown ticks.\n"
                "10. Assume the spark submit will be the same, there is no modification to any of its options and script arguments.\n"
                "11. Single line comments showing changes in the code are ok, as long as each line is properly formatted starting with a #"
