    ...
    prompt = [
        SystemMessage(
            content=(
                ...
                "7. Do not include logic to prevent the original app to complete by stopping execution early."
                ...
                "9. If a common join or merge key is not found from both table schemas, select two best candidate columns from both schemas that will likely match.\n"
                "10. Do not add a How to Run or any other comments and docstrings at the end of the script.\n"
